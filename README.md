...
1.  [Introducción:](#org03daccd)
2.  [Particionamiento del disco](#orgb70a748)
    1.  [Sistema EFI.](#orgc046967)
    2.  [Para equipos BIOS:](#orgd31b347)
3.  [Instalación del Sistema Base:](#org87e7d9e)
4.  [Configuración del Sistema Base](#orga31f706)
5.  [Instalación del Kernel Linux y configuración de GRUB:](#org4a96efa)
6.  [Creación del usuario, instalación de sudo:](#org3b05687)
7.  [Instalación del Entorno de Escritorio:](#org21bf50c)
    1.  [Tasksel, se trata de un menú en NCurses que nos dará una lista de entornos de escritorio disponibles, sólo es cuestión de darle siguiente y siguiente y tasksel se encargará del resto:](#org6eaa41d)
    2.  [Instalación de un BSPWM. Para instalar BSPWM, vamos a necesitar primero los paquetes iniciales para un entorno de Xorg:](#orgb817973)
    3.  [Instalación de Mínima de GNOME.](#org0f8b0fc)
    4.  [Instalación de Mínima de KDE Plasma:](#orgdca9460)
